...
"""
.. module:: selectCPSTrawlEvent

    :synopsis: selectCPSTrawlEvent presents the event selection dialog
...
"""
"""
selectCPSTrawlEvent is a helper function used to launch the CPS select trawl event.
...
import events.CPS_Events.CPSTrawlEvent as CPSTrawlEvent


class SelectCPSTrawlEvent():

    def __init__(self, parent):

        self.parent = parent
        # create an instance of the trawl event dialog and display
        trawl_event = CPSTrawlEvent.CPSTrawlEvent(self.parent)
        trawl_event.exec_()
