...
class Ui_sbeProgressDialog(object):
    def setupUi(self, sbeProgressDialog):
        ...
        self.progressBar = QtWidgets.QProgressBar(parent=sbeProgressDialog)
        font = QtGui.QFont()
        ...
        self.abortButton = QtWidgets.QPushButton(parent=sbeProgressDialog)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(10)
        font.setBold(True)
