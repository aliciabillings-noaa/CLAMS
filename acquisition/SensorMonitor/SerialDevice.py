...
.. module:: SerialDevice
    ...
    :synopsis: SerialDevice handles I/O for an individual serial port.
               ...
               TCP/IP ports are also handled by this class using pySerial's
               TCP support.
...
import re
import serial
from PyQt6.QtCore import pyqtSignal, QObject, QTimer, pyqtSlot
        ...
        if nBytesRx > 0:
            ...
            if (self.parseType <= 10):
                ...
                for line in lines:
                    ...
                    if line.endswith('\n') or line.endswith('\r'):
                        #  this line is complete - strip the newline character(s) and white space
                        line = line.rstrip('\r\n').strip()
