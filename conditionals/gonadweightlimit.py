...
"""
    :module:: GonadWeightLimit

    :synopsis: GonadWeightLimit is a conditional that checks if validations
               are classes that are used by the CLAMS specimen module to check
