...
.. module:: GirthDlg
    ...
    :synopsis: Dialog to enter a measurement of the girth of an organism
...
class GirthDlg(QDialog, ui_NumPad.Ui_numpad):

    def __init__(self, parent=None):
        super(GirthDlg, self).__init__(parent)
        self.setupUi(self)

        # variable declarations
        self.value = None
        self.msgLabel.setText('Enter Girth Measurement')
        self.result = ()
        self.vial = ''
