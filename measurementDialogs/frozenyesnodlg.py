...
"""
.. module:: FrozenYesNoDlg

    :synopsis: Dialog to present yes/no for freezing a fish
...
|       Kresimir Williams   <kresimir.williams@noaa.gov>
| Maintained by:
|       Brittany Schwartzkopf <brittany.schwartzkopf@noaa.gov>
...
class FrozenYesNoDlg(QDialog, ui_YesNoDlg.Ui_YesNoDlg):
    def __init__(self,  parent=None):
        super(FrozenYesNoDlg, self).__init__(parent)
        self.setupUi(self)
