...
"""
.. module:: OvaryYesNoDlg

    :synopsis: Dialog to present yes/no for taking an ovary
...
|           specific updates:
|               - rewrote to match other yesnodlg dialogs
|
"""
...
class OvaryYesNoDlg(QDialog, ui_YesNoDlg.Ui_YesNoDlg):
    def __init__(self,  parent=None):
        super(OvaryYesNoDlg, self).__init__(parent)
        self.setupUi(self)
        ...
        #  set the caption
        self.setCaption('Are you taking an ovary?')
