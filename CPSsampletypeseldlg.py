...
from ui import ui_cpsSampleTypeSelDlg


class CPSsampletypeseldlg(QDialog, ui_cpsSampleTypeSelDlg.Ui_cpsSampleTypeSelDlg):
    def __init__(self,  parent=None):
        super(CPSsampletypeseldlg, self).__init__(parent)
        self.setupUi(self)
