...
class Ui_eventselDlg(object):
    def setupUi(self, eventselDlg):
        ...
        self.eventTable = QtWidgets.QTableWidget(parent=eventselDlg)
        ...
        self.eventTable.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.eventTable.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        ...
        self.eventTable.horizontalHeader().setCascadingSectionResizes(True)
        self.eventTable.horizontalHeader().setMinimumSectionSize(75)
        self.eventTable.horizontalHeader().setSortIndicatorShown(False)
        self.eventTable.horizontalHeader().setStretchLastSection(True)
        self.eventTable.verticalHeader().setDefaultSectionSize(50)
        self.eventTable.verticalHeader().setMinimumSectionSize(50)
        self.verticalLayout.addWidget(self.eventTable)
        self.newEventBtn = QtWidgets.QPushButton(parent=eventselDlg)
        ...
        self.cancelBtn = QtWidgets.QPushButton(parent=eventselDlg)
        ...
        self.okBtn = QtWidgets.QPushButton(parent=eventselDlg)
