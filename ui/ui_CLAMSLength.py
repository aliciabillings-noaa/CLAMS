# Form implementation generated from reading ui file 'CLAMSLength.ui'
#
...
class Ui_clamsLength(object):
    def setupUi(self, clamsLength):
        ...
        self.gridLayout.addWidget(self.picLabel, 3, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.otherBox, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.groupSexBox, 4, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.sciLabel, 2, 0, 1, 2)
        self.label_6 = QtWidgets.QLabel(clamsLength)
        font = QtGui.QFont()
        ...
        self.haulNum = QtWidgets.QLabel(clamsLength)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
    ...
    def retranslateUi(self, clamsLength):
        ...
        self.label_6.setText(_translate("clamsLength", "Event"))
...
if __name__ == "__main__":
    ...
    clamsLength = QtWidgets.QDialog()
    ui = Ui_clamsLength()
    ui.setupUi(clamsLength)
    clamsLength.show()
    sys.exit(app.exec())
