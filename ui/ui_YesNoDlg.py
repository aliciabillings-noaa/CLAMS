# Form implementation generated from reading ui file 'C:\CLAMS_WPy64-31260\CLAMS\ui\YesNoDlg.ui'
#
...
class Ui_YesNoDlg(object):
    def setupUi(self, YesNoDlg):
        ...
        self.msgLabel = QtWidgets.QLabel(parent=YesNoDlg)
        font = QtGui.QFont()
        ...
        self.yesBtn = QtWidgets.QPushButton(parent=YesNoDlg)
        ...
        self.noBtn = QtWidgets.QPushButton(parent=YesNoDlg)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
