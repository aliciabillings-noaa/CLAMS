...
class Ui_clamsCatch(object):
    def setupUi(self, clamsCatch):
        ...
        self.speciesList.horizontalHeader().setStretchLastSection(False)
        ...
        self.manualBtn.setMinimumSize(QtCore.QSize(200, 55))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(14)
        font.setBold(True)
...
"}")
        ...
        self.basketTable.horizontalHeader().setStretchLastSection(False)
